...
from infrastructure.database.sqlite_repository import SQLiteDataRepository
...
class SARSCoVAnalysisSystem:
    ...
    def __init__(self) -> None:
        ...
        load_dotenv()
        # Repositórios
        self.data_repository = SQLiteDataRepository("../data/interim/srag_2019_2024.db")
    ...
    def setup_data_pipeline(self) -> None:
        ...
        print("1. Processando dicionário de dados...")
        ...
        srag_data = self.data_processing.download_and_process_srag_data(
            ...
            config=DataProcessingConfig(mixed_type_columns=MIXED_TYPE_COLUMNS),
        )
